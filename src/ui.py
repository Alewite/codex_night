...
class ScannerUI:
    ...
    def draw_hint(self, screen, font):
        hint_text = font.render("E - сканировать", True, WHITE)
    ...
    def draw(self, screen, font):
        ...
        panel_react = pygame.Rect(panel_x, panel_y, panel_width, panel_height)
        pygame.draw.rect(screen, PANEL_COLOR, panel_react)
        pygame.draw.rect(screen, PANEL_BORDER, panel_react, 3)
